...
##### Intern in Computer vision | Sept 2024 - Now
| *Jumine | Québec, Canada*
Used technologies: Technologies: Pytorch, Ultralytics, MLflow.

##### Research Assistant - Intern in Computer vision | Juin 2024 - Août 2024
| *PaquetLab | Québec, Canada*
Detection of calf health status from a frontal image or short video sequence of the calf at the feed trough. Balanced accuracy: 64.3% with ViT, 58.9% with Timesformer.
Used technologies: Data extraction and analysis, Pytorch, torchvision, transformers, Ultralytics, OmniXAI.
...
Used technologies: DevOps, CI/CD, Cloud Services, Scrum, Agile, UX Design.
...
Used technologies: Angular, Firebase, MongoDB, Cypress.
...
Used technologies: Laravel, Angular, Web API, UX Design.
...
| SPSS Modeler, RStudio, JASP, Scikit-learn, Hugging Face, OpenCV, Ultralytics
METAFLOW, MLflow, PyTorch Lightning, Optuna, Weights & Biases, Tensorboard
...
## Interests
AI, Software Engineering, Web Development, Reading, Traveling, Music, Animes, Swimming, Climbing, BasketBall, and Learning new things.
